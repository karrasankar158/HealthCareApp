  $(document).ready(function () {
        ...
        function validate_specCode() {
          ...
          if (val == "") {
            ...
            $("#specCodeError").show();
            $("#specCodeError").html("*<b>Code</b> must be 6-12 chars only");
            $("#specCodeError").css("color", "red");
            specCodeError = false;
          } else {
        ...
        function validate_specName() {
          ...
          if (val == "") {
            ...
            $("#specNameError").show();
            $("#specNameError").html(
              "*<b>Name</b> must be 4-30 chars and space dot allowed"
            );
            $("#specNameError").css("color", "red");
            specNameError = false;
          } else {
        ...
        function validate_specNote() {
          ...
          if (val == "") {
            ...
            $("#specNoteError").show();
            $("#specNoteError").html(
              "*<b>Note</b> must be 15-500 chars and allowed symbols are . , space - `"
            );
            $("#specNoteError").css("color", "red");
            specNoteError = false;
          } else {
